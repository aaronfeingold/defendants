class DefendantsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @defendant.save
        format.html { redirect_to defendant_url(@defendant), notice: "Defendant was successfully created." }
  ...
  def update
    respond_to do |format|
      if @defendant.update(defendant_params)
        format.html { redirect_to defendant_url(@defendant), notice: "Defendant was successfully updated." }
  ...
  private
    ...
    def defendant_params
      params.require(:defendant).permit(:name, :sex, :race, :date_of_birth, :observation_id, :notes)
    end
end
